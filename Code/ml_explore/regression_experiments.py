...
def build_model(shape,  optimizer='Adamax', layers = 3, act="elu", neurons=512, dropout=0.8):
    """
...
def train_model(X_train, y_train, X_test, y_test, epochs, batch_size, optimizer, layers, activation, neurons, dropout):
    model_DNN = build_model(X_train.shape[1], optimizer, layers, activation, neurons, dropout)
