...
FILE_LINKS = {
    'collection_export': [f'http://files.tmdb.org/p/exports/collection_ids_{today}.json.gz',"collection"],
    'keyword_export': [f'http://files.tmdb.org/p/exports/keyword_ids_{today}.json.gz',"keyword"],
    'person_export': [f'http://files.tmdb.org/p/exports/person_ids_{today}.json.gz',"person"],
