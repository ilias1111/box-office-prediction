...
if __name__ == "__main__":
    ...
    feature_importances_gain = pd.DataFrame(
        {"feature": feature_names, "importance": feature_importance_values_gain}
    )
    feature_importances_gain = feature_importances_gain.sort_values(
        by="importance", ascending=False
    ).reset_index(drop=True)
    ...
    plot_feature_importance(
        feature_importance_values_gain,
        feature_names,
